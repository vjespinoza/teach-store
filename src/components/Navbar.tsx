        ...
        <nav className="bg-gray-800 text-white p-4">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center space-x-6">
                    <Link href="/compare-products" className="flex flex-col items-center text-sm hover:text-gray-300">
                        <span className="text-xs">Compare</span>
                        <span className="text-xs">Products</span>
                    </Link>
                    <Link href="/wishlist" className="flex flex-col items-center text-sm hover:text-gray-300">
                        <Heart size={20}/>
                        <span className="text-xs">Wishlist</span>
                    </Link>
                    <Link href="/my-account" className="flex flex-col items-center text-sm hover:text-gray-300">
                        <User size={20}/>
            ...
            <div
                className="container mx-auto mt-4 bg-gray-700 rounded-md p-2 flex justify-start items-center space-x-6 text-sm">
                <Link href="#" className="font-semibold text-yellow-400">SHOP CATEGORIES</Link>
                <Link href="#" className="hover:text-gray-300">HOME</Link>
                <Link href="#" className="hover:text-gray-300">OUR STORE</Link>
                <Link href="#" className="text-red-400 hover:text-red-300">SPECIAL <span
                    className="bg-red-500 text-white text-xs px-1 rounded">SALE</span></Link>
                <Link href="#" className="hover:text-gray-300">CATEGORIES</Link>
                <Link href="#" className="text-yellow-400 hover:text-yellow-300">TOP DEALS <span
