...
type FilterChangeValue = boolean | number | string | { min?: number; max?: number };
...
export default function Home() {
    ...
    const applyFiltersAndSort = useCallback((currentFilters: ProductFilters, currentSortOption: SortOption) => {
        const filtered = mockProducts.filter(product => {
            ...
            if (currentFilters.productType.length > 0 && !currentFilters.productType.includes(product.category)) {
                return false;
            }
    ...
    const handleFilterChange = (
        ...
        setFilters(prevFilters => {
            ...
            if (filterName === 'inStock') {
                ...
                newFilters.priceRange = { ...prevFilters.priceRange, ...(value as { min?: number; max?: number }) };
            }
            return newFilters;
        });
    };
    ...
    const isFilterActive = filters.inStock ||
        filters.outOfStock ||
            ...
            <div className="container mx-auto p-4 flex gap-6 mt-4">
                <aside className="w-1/4 bg-white p-6 rounded-lg shadow-md h-fit sticky top-4">
                    ...
                    <div className="mb-6">
                        ...
                        <label htmlFor="inStockFilter" className="flex items-center space-x-2 mb-1 cursor-pointer">
                            <input
                                type="checkbox"
                                id="inStockFilter"
                        ...
                        <label htmlFor="outOfStockFilter" className="flex items-center space-x-2 cursor-pointer">
                            <input
                                type="checkbox"
                                id="outOfStockFilter"
                                className="form-checkbox text-blue-600 rounded"
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 mb-2">The highest price is ${initialMaxPrice.toFixed(2)}</p>
                    ...
                    <div className="mb-6">
                        ...
                        {uniqueCategories.map((category) => (
                            <label key={category} htmlFor={`category-${category}`} className="flex items-center space-x-2 mb-1 cursor-pointer">
                                <input
                                    type="checkbox"
                    ...
                    <div className="mb-6">
                        ...
                        {uniqueBrands.map((brand) => (
                            <label key={brand} htmlFor={`brand-${brand}`} className="flex items-center space-x-2 mb-1 cursor-pointer">
                                <input
                                    type="checkbox"
                                    id={`brand-${brand}`}
                                    className="form-checkbox text-blue-600 rounded"
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex space-x-2">
                            <span key="blue-color-filter" className="w-6 h-6 rounded-full bg-blue-600 border border-gray-300 cursor-pointer" role="button" aria-label="Filter by Blue color"></span>
                            <span key="green-color-filter" className="w-6 h-6 rounded-full bg-green-600 border border-gray-300 cursor-pointer" role="button" aria-label="Filter by Green color"></span>
                            <span key="red-color-filter" className="w-6 h-6 rounded-full bg-red-600 border border-gray-300 cursor-pointer" role="button" aria-label="Filter by Red color"></span>
                            <span key="black-color-filter" className="w-6 h-6 rounded-full bg-black border border-gray-300 cursor-pointer" role="button" aria-label="Filter by Black color"></span>
                        </div>
                    </div>

                    <div className="mb-6">
                        <h3 className="font-medium text-gray-700 mb-2">Storage</h3>
                        <label key="64gb-storage" htmlFor="storage-64gb" className="flex items-center space-x-2 mb-1 cursor-pointer">
                            <input type="checkbox" id="storage-64gb" className="form-checkbox text-blue-600 rounded" />
                            <span>64GB (2)</span>
                        </label>
                        <label key="128gb-storage" htmlFor="storage-128gb" className="flex items-center space-x-2 mb-1 cursor-pointer">
                            <input type="checkbox" id="storage-128gb" className="form-checkbox text-blue-600 rounded" />
                            <span>128GB (2)</span>
                        </label>
                        <label key="256gb-storage" htmlFor="storage-256gb" className="flex items-center space-x-2 mb-1 cursor-pointer">
                            <input type="checkbox" id="storage-256gb" className="form-checkbox text-blue-600 rounded" />
                            <span>256GB (2)</span>
                        </label>
                        <label key="512gb-storage" htmlFor="storage-512gb" className="flex items-center space-x-2 mb-1 cursor-pointer">
                            <input type="checkbox" id="storage-512gb" className="form-checkbox text-blue-600 rounded" />
                            <span>512GB (2)</span>
                        </label>
                    </div>
                </aside>
                ...
                <main className="flex-1">
                    <div className="flex justify-between items-center bg-white p-4 rounded-lg shadow-md mb-6">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <button className="p-2 border border-gray-300 rounded-md text-blue-600 hover:bg-gray-100" aria-label="Display as grid with 3 columns">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-grid-3x3"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/></svg>
                            </button>
                            <button className="p-2 border border-gray-300 rounded-md text-gray-500 hover:bg-gray-100" aria-label="Display as list with rows">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-rows"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/></svg>
                            </button>
                        </div>
                    </div>
