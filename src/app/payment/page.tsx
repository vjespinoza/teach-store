...
import { useCart, CustomerDetails as CustomerDetailsType } from '@/context/CartContext';
...
const PaymentPage: React.FC = () => {
    const { cart, getCartTotal, customerDetails, setLastOrderSummary, clearCart } = useCart();
    ...
    const handlePaymentSubmit = (e: FormEvent) => {
        ...
        console.log('Billing Address:', billingAddressSameAsShipping ? 'Same as shipping' : billingAddress);
        ...
        const orderSummary = {
            ...
            billingAddress: billingAddressSameAsShipping ? customerDetails : billingAddress,
        };
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="container mx-auto p-4 py-8">
                <h1 className="text-3xl font-bold text-gray-800 mb-8 text-center">Payment Information</h1>
                                ...
                                <div className="mt-6 p-4 bg-blue-50 rounded-md border border-blue-200">
                                    ...
                                    {customerDetails && (
                                        <address className="not-italic text-sm text-gray-700">
                                            {customerDetails.fullName}<br/>
                                            {customerDetails.addressLine1}<br/>
                                            {customerDetails.addressLine2 && `${customerDetails.addressLine2}<br/>`}
                                            {customerDetails.city}, {customerDetails.state} {customerDetails.zipCode}<br/>
