...
const CheckoutPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            <Navbar
                cartItemCount={cart.reduce((sum, item) => sum + item.quantity, 0)}/> {/* Pass actual cart item count */}
            ...
            <div className="container mx-auto p-4 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 bg-white p-8 rounded-lg shadow-md h-fit sticky top-8">
                        ...
                        {cart.length === 0 ? (
                            <p className="text-center text-gray-500">Your cart is empty. Please add items to
                                proceed.</p>
                        ) : (
                            <>
                        ...
                        ${(item.price * item.quantity).toFixed(2)}
                                ...
                                <div className="border-t border-gray-200 pt-4 mt-4">
                                    ...
                                    <div className="flex justify-between py-1">
                                        ...
                                        <span
                                            className="font-semibold text-green-600">FREE</span> {/* Assuming free shipping for now */}
                                    </div>
                                    <div className="flex justify-between py-1">
