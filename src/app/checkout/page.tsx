      ...
      <div className="container mx-auto p-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            {cart.length === 0 ? (
              <p
                id="checkout-summary-empty-state"
              ...
              <>
                <div
                  id="checkout-summary-product-list"
                  className="space-y-4 mb-6"
                >
                  {cart.map((item) => (
                    <div
                      key={item.id}
                      data-testid="checkout-summary-product"
                    ...
                    >
                      <div className="relative w-16 h-16 flex-shrink-0">
                        <Image
                          ...
                          data-testid="checkout-summary-product-image"
                        />
                      </div>
                      <div className="flex-1">
                        <h3
                          className="font-medium text-gray-800 line-clamp-1"
                          data-testid="checkout-summary-product-name"
                        >
                          {item.name}
                        </h3>
                        <p className="text-sm text-gray-600">
                          $
                          <span data-testid="checkout-summary-product-price">
                            {item.price.toFixed(2)}
                          </span>{" "}
                          x
                          <span data-testid="checkout-summary-product-quantity">
                            {item.quantity}
                          </span>
                        </p>
                      </div>
                      <span
                        ...
                        data-testid="checkout-summary-product-total-price"
                      >
                ...
                <div className="border-t border-gray-200 pt-4 mt-4">
                  ...
                  <div className="flex justify-between py-1">
                    ...
                    <span
                      ...
                      id="checkout-summary-shipping-fee"
                    >
                      FREE
                    </span>{" "}
                  </div>
                  <div className="flex justify-between py-1">
                    ...
                    <span id="checkout-summary-tax" className="font-semibold">
                      ${taxes.toFixed(2)}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 text-lg font-bold">
                    <span>Order Total:</span>
                    <span id="checkout-summary-order-total">
                      ${total.toFixed(2)}
                    </span>
                  </div>
                </div>
